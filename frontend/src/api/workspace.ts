...
import type { CreditLog, GenerationTask, ModelConfig, SceneConfig } from '../types';
...
export const workspaceApi = {
  ...
  createTask: async (payload: { clothingUrl: string; modelConfig: ModelConfig; sceneConfig: SceneConfig }) => {
