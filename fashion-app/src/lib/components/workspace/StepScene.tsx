    ...
    <>
      ...
      <div className="field" style={{ marginBottom: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          <button
            type="button"
            className={`btn-secondary ${value.mode === 'preset' ? 'btn-active' : ''}`}
          ...
          <button
            type="button"
            className={`btn-secondary ${value.mode === 'replace' ? 'btn-active' : ''}`}
      ...
      {value.mode === 'replace' && (
        <div style={{ marginBottom: '20px' }}>
          ...
          <span className="helper-text" style={{ color: '#f59e0b', marginTop: '8px', display: 'block' }}>
            上传一张参考图片，AI 将保留其背景和姿势，仅替换模特（面部和体型根据模特配置）和服装
          </span>
        </div>
      )}
        ...
        <>
          <div className="field" style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              <button
                type="button"
                className={`btn-secondary ${value.sceneSource === 'preset' ? 'btn-active' : ''}`}
              ...
              <button
                type="button"
                className={`btn-secondary ${value.sceneSource === 'upload' ? 'btn-active' : ''}`}
          ...
          <div className="field" style={{ marginBottom: '20px' }}>
            ...
            <select
              ...
              onChange={(e) => onChange({ ...value, depthOfField: e.target.value as 'slight' | 'shallow' | 'deep' })}
            >
