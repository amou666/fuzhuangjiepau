...
export default function HistoryPage() {
  ...
  const handleUpscale = async (factor: number) => {
    ...
    const taskId = upscaleModal.taskId;
    ...
    try {
      await workspaceApi.upscaleTask(taskId, factor);
      // 轮询等待放大完成
                    ...
                    <div className="image-row">
                      ...
                      {record.sceneConfig?.imageUrl && (
                        <div className="image-item">
                          ...
                          />
                          <div className="image-overlay">
                            <button className="icon-btn" onClick={() => setPreviewImage(record.sceneConfig.imageUrl ?? null)} title="放大">
                              🔍
                            </button>
                    ...
                    <div className="image-row">
                      <div className="image-item">
                        ...
                        <div className="image-overlay">
                          ...
                          {record.status === 'COMPLETED' && !record.upscaledUrl && !upscalingTaskIds.has(record.id) && (
                            <button 
                              className="icon-btn" 
                      ...
                      {!record.upscaledUrl && upscalingTaskIds.has(record.id) && (
                        <div className="image-item" style={{
                          ...
                          <div style={{ fontSize: '13px', color: '#6b7280' }}>正在放大中...</div>
                        </div>
                      )}
                    </div>
                  </div>
          ...
          <div className="modal-content" style={{ maxWidth: '480px', padding: '32px' }} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
              ...
              >
                ...
                <div style={{ fontSize: '12px', color: '#6b7280' }}>消耗 1 积分</div>
              </button>
            </div>
            {upscaleLoading && (
