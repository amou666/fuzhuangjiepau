...
export default function CustomersContent() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {error && (
        <div className="bg-[rgba(196,112,112,0.08)] text-red-600 px-4 py-3 rounded-2xl text-sm font-medium border border-red-100">
          {error}
        </div>
      )}
                  ...
                  <td className="px-4 py-3 border-b border-gray-100 text-gray-700">
                    {editingCustomerId === customer.id ? (
                      <div className="flex gap-2 items-center">
                        <input
                          className="w-full px-2 py-1.5 bg-white/75 border border-black/10 rounded-2xl text-xs"
                          type="text"
                          value={editingApiKey}
                          onChange={(e) => setEditingApiKey(e.target.value)}
                        />
                        <button
                          className="inline-flex items-center justify-center px-2 py-1.5 bg-gradient-to-r from-blue-500 to-indigo-500 text-white border-none rounded-2xl text-xs font-semibold"
                          onClick={() => saveApiKey(customer.id)}
                        >
                          保存
                        </button>
                        <button
                          className="inline-flex items-center justify-center px-2 py-1.5 bg-white/70 text-gray-700 border border-black/10 rounded-2xl text-xs font-medium backdrop-blur-sm hover:bg-white/90 hover:border-blue-500/30 hover:text-blue-500"
                      ...
                      <div className="flex gap-2 items-center">
                        ...
                        <button
                          className="inline-flex items-center gap-1 px-2 py-1.5 bg-white/70 text-gray-700 border border-black/10 rounded-2xl text-xs font-medium backdrop-blur-sm hover:bg-white/90 hover:border-blue-500/30 hover:text-blue-500"
