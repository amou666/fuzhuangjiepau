        ...
        <div className="fashion-glass rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                className="w-full px-3 py-2 border border-gray-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 resize-none"
                rows={2}
                  ...
                  <tr key={t.id} className="hover:bg-blue-500/[0.03] transition-colors">
                    <td className="px-4 py-3 border-b border-gray-100">
                      <div className="flex items-center gap-2">
                        {t.previewUrl && (
                          <img src={t.previewUrl} alt="" className="w-8 h-8 rounded-2xl object-cover border border-gray-100" />
                        )}
