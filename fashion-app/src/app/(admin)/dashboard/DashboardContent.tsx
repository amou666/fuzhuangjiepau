        ...
        <>
          ...
          <div className="grid grid-cols-4 gap-5 max-md:grid-cols-2">
            {metrics.map((m) => (
              ...
              >
                <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${m.color} flex items-center justify-center shadow-lg shrink-0`}>
            ...
            <div className="fashion-glass rounded-2xl p-6">
              ...
              <div className="flex flex-col gap-2">
                {data.dailyTasks.map((item) => (
                  <div
                    key={item.date}
                    className="flex items-center justify-between px-4 py-3 bg-gray-50/80 rounded-2xl text-sm"
                  >
          ...
          {/* Recent Tasks Table */}
          <div className="fashion-glass rounded-2xl p-6">
            <h2 className="text-sm font-semibold text-gray-900 m-0 mb-4">最近任务</h2>
