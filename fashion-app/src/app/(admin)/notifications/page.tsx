          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 bg-white text-[13px] text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-200"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 bg-white text-[13px] text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-200 resize-none"
              />
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2 mb-3">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-[12px] font-semibold border transition-all ${
              ...
              {targetMode === 'selected' && (
                <div className="max-h-[200px] overflow-y-auto border border-gray-200 rounded-xl p-2 flex flex-col gap-1">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 px-6 rounded-xl text-white text-[14px] font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div className="fashion-glass rounded-2xl p-6">
          ...
          {history.length === 0 ? (
            ...
            <div className="flex flex-col gap-2 max-h-[480px] overflow-y-auto">
              {history.map((n: any) => (
                <div key={n.id} className="p-3 bg-gray-50/60 rounded-xl border border-gray-100">
